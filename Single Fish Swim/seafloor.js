...
function weed1()
{
  ...
  {     
    ...
    ellipse(width/2+ 25 * sin(degree)*i/5 -350+120, height-25*i-200-12-5, 15 - i, 30 - 2*i)
  }
}
...
function weed2()
{
  ...
  {     
    ...
    ellipse(width/2+ 25 * cos(degree)*i/10-420+120, height-20*i-200-15-5, 25 - i, 45 - 2*i)
  }
}
...
function weed3()
{
  ...
  {     
    ...
    ellipse(width/2+ 25 * sin(degree)*i/10-380+120, height-25*i-200-15-5, 20 - 1.2*i, 45 - 2*i)
  }
}
function weed4()
{
